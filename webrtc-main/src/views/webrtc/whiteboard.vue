    ...
    <div class="demo">
        <div class="rtcBox">
            ...
            <div class="canvas-wrapper">
                <canvas width="800" height="600" ref="canvas" id="my-canvas0"></canvas>
                <button v-on:click="saveImageInfo">save</button>
                <h5>白板操作</h5>
            </div>
            <div class="canvas-wrapper">
                <canvas width="800" height="600" ref="canvas2" id="my-canvas1"></canvas>
                <button v-on:click="saveImageInfo">save</button>
                <h5>白板操作</h5>
            </div>
            <div>
    ...
    export default {
        ...
        methods: {
            ...
            initPeer() {
                ...
                this.peerA.addStream(this.localstream2); // 添加本地流
                // 监听 A 的ICE候选信息
                // 如果收集到，就添加给 B
...
//                    console.log('event-stream', event.stream);
            ...
            async createMedia() {
                // 把 localstream2 换成 localstream 也可以，二者都是data中自定义数据
                // 保存本地流到全局
                this.localstream2 = this.$refs['canvas'].captureStream();
