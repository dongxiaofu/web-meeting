    ...
    <div>
        <div id="left-side">
            ...
            <div class="message">
                <h6>笔记</h6>
                <ul>
                    <li class="notes-icon">分享笔记</li>
                </ul>
            </div>
            <div class="user-list">
                <h6>用户<span class="user-num">({{participantNumber}})</span></h6>
                <ul>
                    <!--用更简单的if写法吗-->
        ...
        <span>
            ...
            <div class="msg-list">
                <ul>
                    ...
                    <!--<li>-->
                        <!--<p class="speaker">-->
                            <!--chuganghong-->
                            <!--<span class="post-time">2018-10-8 14:52:32</span>-->
                        <!--</p>-->
                        <!--<p>-->
                            <!--欢迎来到主会议室！-->
                            <!--请参考使用说明。请参考使用说明。请参考使用说明。请参考使用说明。请参考使用说明。请参考使用说明。请参考使用说明。-->
                        <!--</p>-->
                    <!--</li>-->
                    <!--<li>-->
                        <!--<p class="speaker">-->
            ...
            <div class="msg-ipt">
                ...
                <i class="send-icon" v-on:click="sendMsg"></i>
            </div>
        </div>
        <div id="wrapper">
            <div id="paint-board">
                ...
                <div id="foot-wrapper">
                    <div id="my-foot">
                        <div id="media-operation">
                            <span class="phone"><i class="phone-icon"></i></span>
                            <span class="video"><i class="video-icon"></i></span>
                        </div>
                    </div>
                </div>
                <div id="side-tool">
                    <ul>
                        <li><i class="more-tool-icon"></i></li>
                        <li class="last"><i class="delete-icon"></i></li>
                    </ul>
                </div>
                <div id="paint-tool">
                    <!--画板工具区 start-->
        ...
        methods: {
            ...
            send(arr) { // 发送消息
                ...
                for (let channelKey in this.channelList) {
                    ...
                    console.log(channel)
                    console.log('channel b = ' + channel.readyState)
                    console.log('channel f = ' + channel.readyState)
                    if (arr[0] === 'text') {
                        let params = {
...
//                     video.srcObject = event.stream;
            ...
            createDataChannel(account) { // 创建 DataChannel
                try {
                    let channel = this.peerList[account].createDataChannel('messagechannel');
            ...
            onDataChannel(account) { // 接收 DataChannel
                this.peerList[account].ondatachannel = (event) => {
                    // console.log('ondatachannel', event);
                    this.receiverChannel = event.channel
        ...
        mounted() {
            ...
            this.$nextTick(() => {
                ...
                for (var i = 0; i < 1; i++) {
                    ...
                    // img.src="https://img.tupianzj.com/uploads/allimg/202001/9999/74ed1af175.jpg"
                    // {mediaSource: 'screen'}
